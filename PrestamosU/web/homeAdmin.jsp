...
<body class="header-fixed boxed-layout" style="position: relative; min-height: 100%; top: 0px;">
    ...
    <div class="container">
        <form action="espacios?action=save" method="post">
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="form-group">
                        <label for="email">Dimenciones</label>
                    ...
                    <div class="form-group">
                        <select style="height: 35px;" class="form-control" id="dependencia" name="dependencia">
                            ...
                            %>
                            <option value="<%=dep.getId_dependencia()%>"><%=dep.getNombre()%></option>
                            <%
                                }
                            %>
                        </select>
                ...
                <div class="col-6">
                    <div class="form-group">
                        <label for="documento">Capacidad</label>
                        <input type="text" class="form-control" id="capacidad" placeholder="Capacidad" name="capacidad">
                    </div>
                    <div class="form-group">
                        <label for="celular">Descripcion</label>
                        <input type="text" class="form-control" id="descripcion" placeholder="Descripcion" name="descripcion">
                    </div>
                    <div class="form-group">
                        <label for="direccion">Valor x Hora</label>
                        <input type="text" class="form-control" id="valor" placeholder="Valor por hora" name="valor">
                    </div>
                    <div class="form-group">
                        <label for="clave">Dispositivo</label>
                        <select style="height: 35px;" class="form-control" id="dispositivo" name="dispositivo">
                            <%
                                for (Elemento ele : e.listarElementos()) {
        ...
        <div class="row mt-5">
            <div class="col-12">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <%
                            for (Espacio el : e.listarEspacios()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="espacios?action=delete&id=<%=el.getIdSpacios()%>" class="btn btn-danger">Eliminar</a>
                                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal<%=el.getIdSpacios()%>">Actualizar</button>

                                <!-- Modal -->
                                <div id="myModal<%=el.getIdSpacios()%>" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Editar el Registro <%=el.getIdSpacios()%></p>

                                                <form action="espacios?action=editar" method="post">
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label for="documento">Id</label>
                                                                <input type="text" value="<%=el.getIdSpacios()%>" class="form-control" id="id" placeholder="Id" name="id" readonly="">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="nombre">Nombre</label>
                                                                <input type="text" value="<%=el.getnombre()%>" class="form-control" id="nombre" placeholder="Nombre" name="nombre">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="email">Dimenciones</label>
                                                                <input type="text" value="<%=el.getDimenciones()%>" class="form-control" id="dimencion" placeholder="Dimenciones" name="dimencion">
                                                            </div>
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label for="documento">Capacidad</label>
                                                                <input type="text" value="<%=el.getCapacidad()%>" class="form-control" id="capacidad" placeholder="Capacidad" name="capacidad">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="celular">Descripcion</label>
                                                                <input type="text" value="<%=el.getDescripcion()%>" class="form-control" id="descripcion" placeholder="Descripcion" name="descripcion">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="direccion">Valor x Hora</label>
                                                                <input type="text" value="<%=el.getValor_hora()%>" class="form-control" id="valor" placeholder="Valor por hora" name="valor">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="clave">Dispositivo</label>
                                                                <select style="height: 35px;" class="form-control" id="dispositivo" name="dispositivo">
