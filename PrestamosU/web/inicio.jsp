...
<body class="header-fixed boxed-layout" style="position: relative; min-height: 100%; top: 0px;">
    ...
    <div class="container">
        ...
        <center> <a href="registro.html"><i class="fa fa-user-o fa-4x" aria-hidden="true"></i>  REGISTRARSE</a></center>
    </li>
</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="pass" placeholder="celular" name="pass">
                                </div>
